...
| Audio Search Algorithm | Tecnologia de busqueda de audio, que se puede utilizar en ambientes ruidosos. Se generan "huellas" transformando las frecuencias de los audios y guardandolas en bases de datos que se reconocen mediante algoritmos de comparacion. | ![imagen_audio_search](https://d3i71xaburhd42.cloudfront.net/e76af50e96b12fc507e73b025fe9da4a99600af9/6-Figure5-1.png)|
